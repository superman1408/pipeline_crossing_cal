...
# Added login_date_for_report back into the function signature
def generate_pipeline_report(filename, input_data, calculation_results, username="N/A", project_title="Untitled Project"):
    ...
    # Changed header to include 'Unit' column
    input_data_for_report = [["Parameter", "Value", "Unit"]]
    # Mapped units for input parameters
    input_units = {
    ...
    # Display names without units in them now
    input_display_names = {
    ...
    # Adjusted colWidths for three columns
    ...
    # Mapped units for output parameters
    output_units = {
    ...
    # Display names without units now
